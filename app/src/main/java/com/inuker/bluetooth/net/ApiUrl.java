...
public class ApiUrl {
    ...
    public static final String API_CHARGE_START = BASE_URL + "api/ChargingData/ChargAskStart";
    /// 远程充电桩关闭
    //api/ChargingData/EpileClose(string rid, string membercode)
    public static final String API_CHARGE_STOP = BASE_URL + "api/ChargingData/EpileClose";
